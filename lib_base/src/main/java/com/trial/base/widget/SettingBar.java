...
import com.trial.base.utils.PixelUtil;
...
public final class SettingBar extends FrameLayout {
    ...
    public SettingBar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mLeftView.setPaddingRelative((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 15, getResources().getDisplayMetrics()),
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 15, getResources().getDisplayMetrics()),
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 15, getResources().getDisplayMetrics()),
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 15, getResources().getDisplayMetrics()));
        mRightView.setPaddingRelative((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 15, getResources().getDisplayMetrics()),
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 15, getResources().getDisplayMetrics()),
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 15, getResources().getDisplayMetrics()),
                (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 15, getResources().getDisplayMetrics()));
        ...
        // 文字颜色设置
        setLeftColor(array.getColor(R.styleable.SettingBar_bar_leftColor, ContextCompat.getColor(getContext(), R.color.color_333333)));
        ...
        setRightSize(TypedValue.COMPLEX_UNIT_SP, array.getDimensionPixelSize(R.styleable.SettingBar_bar_rightSize, 15));
        ...
        if (array.hasValue(R.styleable.SettingBar_bar_lineMargin)) {
            setLineMargin(array.getDimensionPixelSize(R.styleable.SettingBar_bar_lineMargin, PixelUtil.dp2px(15)));
        } else {
            if (array.hasValue(R.styleable.SettingBar_bar_leftIcon)) {
                setLineMargin(array.getDimensionPixelSize(R.styleable.SettingBar_bar_lineMargin, PixelUtil.dp2px(43)));
            } else {
                setLineMargin(array.getDimensionPixelSize(R.styleable.SettingBar_bar_lineMargin, PixelUtil.dp2px(15)));
            }
        }
    ...
    public SettingBar setLeftIcon(Drawable drawable) {
        drawable.setBounds(0, 0, PixelUtil.dp2px(18), PixelUtil.dp2px(18));
